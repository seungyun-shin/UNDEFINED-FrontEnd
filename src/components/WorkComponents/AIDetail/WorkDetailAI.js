                        ...
                        <div className="work-contents-container">
                            ...
                            <div className="work-title-container">
                                ...
                                <div className="work-detail-title">
                                    <span className='work-detail-title-en'>Demand and Vacancy Forecasting DeepLearning Models for Train</span>
                                    <span className='work-detail-title-ko'>열차 수요 및 공석 예측 딥러닝 모델</span>
                                </div>
