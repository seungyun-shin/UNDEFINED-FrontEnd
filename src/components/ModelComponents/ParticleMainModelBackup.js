...
// shader texture
import mask from '../../assets/images/models/particle.jpeg'
    ...
    useEffect(() => {
      ...
      class Sketch{
        constructor(){
          ...
          document.getElementById('particle-mesh-container').appendChild( this.renderer.domElement );
        ...
        mouseEffects(){
         ...
         window.addEventListener('mousedown', (e)=>{
          ...
          window.addEventListener( 'mousemove', (event) =>{
            ...
            this.mesh.rotation.x =  this.mouse.x * 0.1;
            this.mesh.rotation.y =  this.mouse.y * 0.1;
            this.mesh.rotation.z =  this.mouse.y * 0.1;
