    ...
    useEffect(() => {
        ...
        class Sketch{
            constructor(){
                ...
                this.width = icoshadrenContainer.current.offsetWidth;
                this.height = icoshadrenContainer.current.offsetHeight;
                icoshadrenContainer.current.appendChild( this.renderer.domElement );
